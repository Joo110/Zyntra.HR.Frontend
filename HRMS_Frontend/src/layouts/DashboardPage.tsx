...
const leaveRequests = [
  { name: "Ahmed Al-Rashid",    type: "Annual Leave", dates: "Jun 9, 2026 – Jun 14, 2026",  status: "pending"  },
  { name: "Fatima Al-Qahtani", type: "Sick Leave",   dates: "Jun 5, 2026 – Jun 9, 2026",   status: "approved" },
  { name: "Noura Al-Dosari",   type: "Annual Leave", dates: "Jun 20, 2026 – Jun 30, 2026", status: "pending"  },
  { name: "Khalid Al-Harbi",   type: "Unpaid Leave", dates: "Jun 5, 2026 – Jun 12, 2026",  status: "rejected" },
];

const activities = [
  { icon: "👤", text: "New employee onboarded",       sub: "Faris Al-Mutairi • Engineering",   time: "2 hours ago", color: "bg-blue-100 text-blue-600"   },
  { icon: "✅", text: "Leave request approved",        sub: "Finance Team • HR",                time: "4 hours ago", color: "bg-green-100 text-green-600"  },
  { icon: "💰", text: "Payroll processed",             sub: "Finance Team • Finance",           time: "1 day ago",   color: "bg-purple-100 text-purple-600" },
  { icon: "⏰", text: "Attendance marked late",        sub: "Nader Al-Johani • Sales",          time: "2 days ago",  color: "bg-yellow-100 text-yellow-600" },
  { icon: "📊", text: "Performance review submitted", sub: "Mohammed Al-Otaibi • Sales",       time: "3 days ago",  color: "bg-blue-100 text-blue-600"   },
];
...
const stats = [
  { label: "Total Employees", value: "154",     icon: Users,      change: "+2.25%", up: true,  color: "text-blue-500",  bg: "bg-blue-50"  },
  { label: "Present Today",   value: "120",     icon: Clock,      change: "+1.35%", up: true,  color: "text-blue-500",  bg: "bg-blue-50"  },
  { label: "On Leave",        value: "30",      icon: CalendarOff,change: "-6%",    up: false, color: "text-red-400",   bg: "bg-red-50"   },
  { label: "Monthly Payroll", value: "$24,025", icon: DollarSign, change: "+2.5K",  up: true,  color: "text-green-500", bg: "bg-green-50" },
];

// ─── Fix: recharts formatter accepts (value: ValueType) which can be undefined ─

const payrollFormatter = (value: number | string | undefined): string => {
    ...
    <div className="p-4 lg:p-6 space-y-5 min-h-screen bg-[#f7f8fc]">
        ...
        {stats.map((s) => (
          <div key={s.label} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <div className={`flex items-center gap-1 text-xs mt-1 ${s.up ? "text-green-500" : "text-red-500"}`}>
              ...
              {s.change} <span className="text-gray-400">vs last month</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          <div className="mb-3">
            <h2 className="text-sm font-semibold text-gray-900">Attendance Trends</h2>
            <p className="text-xs text-gray-400">Monthly attendance overview</p>
          </div>
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={attendanceData} barSize={12}>
              ...
              <Bar dataKey="present" name="Present" fill="#4F8EF7" radius={[3, 3, 0, 0]} />
              <Bar dataKey="leave"   name="Leave"   fill="#a78bfa" radius={[3, 3, 0, 0]} />
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <div className="mb-3">
          <h2 className="text-sm font-semibold text-gray-900">Payroll Trends</h2>
        ...
        <ResponsiveContainer width="100%" height={180}>
          <LineChart data={payrollData}>
            ...
            />
            {/* ✅ Fix: accept value as number | string | undefined */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="text-xs text-[#4F8EF7] hover:underline">View All</button>
          </div>
              ...
              <div key={i} className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 truncate">{r.type} • {r.dates}</p>
                  </div>
                </div>
